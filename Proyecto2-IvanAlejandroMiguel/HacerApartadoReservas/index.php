...
/* Se crea una consulta para recuperar todos los datos de las reservas con fecha del día en curso.
La consulta de selección se crea de tal modo que ordene las reservas por la hora. */
...
página de cambio de fecha actual. -->
      ...
      <hr>
      <?php
/* Se comprueba si hay reservas en el cursor. Si es así, se dibujará una
tabla en la que se mostrarán las reservas y unos botones de selección. */
...
modificarla o borrarla. El valor del botón es el identificativo de la reserva,
...
eliminación en las páginas que proceda.*/
          ...
          echo ("</table>");
/* Si existen reservas se mostrarán los botones de borrar y modificar. */
