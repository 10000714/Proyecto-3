...
// Se leen los datos de la cita, en la tabla "citas".
  $consulta="SELECT hora_Reserva, asunto_Reserva FROM citas WHERE id_Reserva='".$_POST["reservaSeleccionada"]."';";
...
/* Se asignan los datos actuales de la cita a variables de memoria, se libera el cursor y se cierrqa la BBDD. */
  $horaActual=substr($datosDeLaCita["hora_Reserva"],0,2);
  $minutoActual=substr($datosDeLaCita["hora_reserva"],3,2);
  $asuntoActual=$datosDeLaCita["asunto_reserva"];
...
/* La siguiente función envía el formulario a donde proceda.*/
  ...
  <body onLoad="javascript:mostrarDatos();">
    <form action="" method="post" name="formularioNuevaCita" id="formularioNuevaReserva">
      <input type="hidden" name="fechaEnCurso" id="fechaEnCurso" value="<?php echo($fechaEnCurso); ?>">
      <input type="hidden" name="reservaSeleccionada" id="reservaSeleccionada" value="<?php echo ($_POST["reservaSeleccionada"]); ?>">
      ...
      <table width="500" height="44" border="0" cellpadding="0" cellspacing="0">
        <tr align="center">
          <td width="248"><input name="grabarReserva" type="button" id="grabarReserva" value="Grabar cambios" onClick="javascript:mandar(true);"></td>
          <td width="252"><input name="anularReserva" type="button" id="anularReserva" value="Descartar los cambios" onClick="javascript:mandar(false);"></td>
        </tr>
      </table>
  </form>
  </body>
